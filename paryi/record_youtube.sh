...
while true; do
  ...
  echo "$METADATA" > "/home/centos/live-stream-recorder/savevideo/paryi/$FNAME.info.txt"
  ...
  streamlink --hls-live-restart --loglevel trace -o "/home/centos/live-stream-recorder/savevideo/paryi/$FNAME" \
