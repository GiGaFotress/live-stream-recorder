...
while true; do
  ...
  echo "$METADATA" > "/home/centos/live-stream-recorder/savevideo/mana/$FNAME.info.txt"
  ...
  streamlink --hls-live-restart --loglevel trace -o "/home/centos/live-stream-recorder/savevideo/mana/$FNAME" \
