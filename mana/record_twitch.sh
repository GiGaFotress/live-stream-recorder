...
while true; do
  ...
  # Start recording
  ffmpeg -i "$M3U8_URL" -codec copy -f mpegts "/home/centos/live-stream-recorder/savevideo/mana/$FNAME" > "/home/centos/live-stream-recorder/savevideo/mana/$FNAME.log" 2>&1
