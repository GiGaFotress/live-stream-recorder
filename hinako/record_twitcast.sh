...
while true; do
  ...
  ffmpeg -reconnect_streamed 1 -reconnect_delay_max 2 -i "$M3U8_URL" -codec copy -f mpegts "/home/centos/live-stream-recorder/savevideo/hinako/$FNAME" > "/home/centos/live-stream-recorder/savevideo/hinako/$FNAME.log" 2>&1 &
