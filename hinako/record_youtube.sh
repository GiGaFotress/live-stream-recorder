...
while true; do
  ...
  echo "$METADATA" > "/home/centos/live-stream-recorder/savevideo/hinako/$FNAME.info.txt"
  ...
  # Start recording
  # ffmpeg -i "$M3U8_URL" -codec copy -f mpegts "$FNAME" > "savevideo/hinako/$FNAME.log" 2>&1
