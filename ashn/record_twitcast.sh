...
while true; do
  ...
  ffmpeg -i "$M3U8_URL" -codec copy -f mpegts "/home/centos/live-stream-recorder/savevideo/ashn/$FNAME" > "/home/centos/live-stream-recorder/savevideo/ashn/$FNAME.log" 2>&1 &

  # Start recording
  ./livedl -tcas "/home/centos/live-stream-recorder/savevideo/ashn/$1" > "/home/centos/live-stream-recorder/savevideo/ashn/$FNAME.livedl.log" 2>&1
