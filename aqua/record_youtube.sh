...
while true; do
  ...
  echo "$METADATA" > "/home/centos/live-stream-recorder/savevideo/aqua/$FNAME.info.txt"
  ...
  # Start recording
  # ffmpeg -i "$M3U8_URL" -codec copy -f mpegts "$FNAME" > "/home/centos/live-stream-recorder/savevideo/aqua/$FNAME.log" 2>&1

  # Use streamlink to record for HLS seeking support
  streamlink --hls-live-restart --loglevel trace -o "/home/centos/live-stream-recorder/savevideo/aqua/$FNAME" \
